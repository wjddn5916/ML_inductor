...
oDesktop.OpenProject("Y:/git/ML_inductor/inductor_LRT_v1/script7/ML_aedt/ML7.aedt")

oProject = oDesktop.SetActiveProject("ML7")
...
oModule.ExportToFile("inductance", "Y:/git/ML_inductor/inductor_LRT_v1/script7/ML_data/inductance_$VERSION_IDX_STR.csv", False)
oModule.ExportToFile("Loss", "Y:/git/ML_inductor/inductor_LRT_v1/script7/ML_data/Loss_$VERSION_IDX_STR.csv", False)
