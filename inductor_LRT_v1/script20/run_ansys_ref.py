...
oDesktop.OpenProject("Y:/git/ML_inductor/inductor_LRT_v1/script20/ML_aedt/ML20.aedt")

oProject = oDesktop.SetActiveProject("ML20")
...
oModule.ExportToFile("inductance", "Y:/git/ML_inductor/inductor_LRT_v1/script20/ML_data/inductance_$VERSION_IDX_STR.csv", False)
oModule.ExportToFile("Loss", "Y:/git/ML_inductor/inductor_LRT_v1/script20/ML_data/Loss_$VERSION_IDX_STR.csv", False)
