...
def run_simul(version_idx_str):
    ...
    temp1 = pd.read_csv(f'Y:\git\\ML_inductor\inductor_LRT_v1\script24\ML_data\inductance_{version_idx_str}.csv', sep=",")
    temp1 = temp1.to_numpy()
    
  
    temp2 = pd.read_csv(f'Y:\git\ML_inductor\inductor_LRT_v1\script24\ML_data\loss_{version_idx_str}.csv', sep=",")
...
for i in range(1, 10000): 
    ...
    try :
        ...
        if os.path.isfile(f'.\ML_aedt\ML24.aedt.lock') :
