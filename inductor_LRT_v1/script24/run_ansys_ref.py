...
oDesktop.OpenProject("Y:/git/ML_inductor/inductor_LRT_v1/script24/ML_aedt/ML24.aedt")
...
oModule.ExportToFile("inductance", "Y:/git/ML_inductor/inductor_LRT_v1/script24/ML_data/inductance_$VERSION_IDX_STR.csv", False)
oModule.ExportToFile("Loss", "Y:/git/ML_inductor/inductor_LRT_v1/script24/ML_data/Loss_$VERSION_IDX_STR.csv", False)
