...
oDesktop.OpenProject("Y:/git/ML_inductor/inductor_LRT_v1/script133/ML_aedt/ML133.aedt")

oProject = oDesktop.SetActiveProject("ML133")
...
oModule.ExportToFile("inductance", "Y:/git/ML_inductor/inductor_LRT_v1/script133/ML_data/inductance_$VERSION_IDX_STR.csv", False)
oModule.ExportToFile("Loss", "Y:/git/ML_inductor/inductor_LRT_v1/script133/ML_data/Loss_$VERSION_IDX_STR.csv", False)
