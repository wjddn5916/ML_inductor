...
oDesktop.OpenProject("Z:\ANSYS_simulation\inductor_practice\inductor_aedt\inductor1.aedt")
...
oModule.ExportToFile("inductance", "Z:/ANSYS_simulation/inductor_practice/inductance/inductance_$VERSION_IDX_STR.csv", False)
oModule.ExportToFile("Loss", "Z:/ANSYS_simulation/inductor_practice/loss/Loss_$VERSION_IDX_STR.csv", False)
